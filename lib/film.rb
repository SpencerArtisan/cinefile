...
class Film
  attr_accessor :year, :link, :rating, :id, :review, :synopsis, :image
  ...
  def to_hash
    ...
    {id: id, title: title, year: year, link: link, rating: rating, image: image, synopsis: synopsis, review: review, showings: showings_hash}
  end
